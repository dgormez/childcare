...
namespace ChildCare.Infrastructure.Persistence.Migrations.Tenant
{
    ...
    [Migration("20260723132743_MakeDateOfBirthOptionalDropGpAddNrnHash")]
    partial class MakeDateOfBirthOptionalDropGpAddNrnHash
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChildCare.Domain.Entities.CodaImport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("coda_imports", "tenant_template");
                });

            modelBuilder.Entity("ChildCare.Domain.Entities.CodaTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SenderIbanEncrypted")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("SenderIbanLast4")
                        .IsRequired()
                        .HasMaxLength(4)
                        .HasColumnType("character varying(4)");
                    ...
                    b.HasIndex("ValueDate", "AmountCents", "SenderIbanLast4");

                    b.ToTable("coda_transactions", "tenant_template", t =>
                        {
                            t.HasCheckConstraint("CK_coda_transactions_match_type", "\"MatchType\" IN ('Ogm','IbanAmount','Unmatched','Duplicate','ClosedInvoice','Reversal')");
                        });
                });
            ...
            modelBuilder.Entity("ChildCare.Domain.Entities.StaffLeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StaffProfileId", "CreatedAt");

                    b.ToTable("staff_leave_requests", "tenant_template");
                });
            ...
            modelBuilder.Entity("ChildCare.Domain.Entities.StaffProfile", b =>
                {
                    ...
                    b.Property<string[]>("ContractedDays")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasDefaultValueSql("'{}'");
            ...
            modelBuilder.Entity("ChildCare.Domain.Entities.CodaTransaction", b =>
                {
                    b.HasOne("ChildCare.Domain.Entities.CodaImport", null)
                        .WithMany()
                        .HasForeignKey("ImportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ChildCare.Domain.Entities.Invoice", null)
                        .WithMany()
