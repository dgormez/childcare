...
// FR-013: personal email/password only (role=staff JWT path) — never the shared
// caregiver-tablet device token, and no Google/Apple OAuth (spec.md only requires
// email/password for staff, unlike parent-mobile's fuller auth stack).
